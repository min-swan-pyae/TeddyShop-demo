...
const Header = () => {
  // you can use selector for every slices in the store
  ...
  return (
    <header className="py-0">
      <Navbar bg="success" variant="success" expand="md" collapseOnSelect>
        <Container>
          <LinkContainer to="/">
            <Navbar.Brand>
              <img src={logo} className="logoBrand" alt="Logo"></img>
            </Navbar.Brand>
          </LinkContainer>
