            ...
            <FormContainer>
                ...
                { isLoading ? <Loader /> : error ? <Message variant='danger'>{ error }</Message> : (
                    <Form onSubmit={ submitHandler }>
                        ...
                        {/* Image Input Placeholder (using multer) */ }
                        ...
                        <Form.Group controlId="brand" className="my-2">
                            <Form.Label style={ { fontWeight: 'bold', color: 'black' } }>Brand</Form.Label>
                            <Form.Control type="text" placeholder="Enter Brand" value={ brand } onChange={ (e) => setBrand(e.target.value) }></Form.Control>
                        </Form.Group>
                        <Form.Group controlId="countInStock" className="my-2">
                            <Form.Label style={ { fontWeight: 'bold', color: 'black' } }>Count In Stock</Form.Label>
                        ...
                        <Form.Group controlId="category" className="my-2">
                            <Form.Label style={ { fontWeight: 'bold', color: 'black' } }>Category</Form.Label>
